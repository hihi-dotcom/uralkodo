...
for(let a = 0; a < array.length; a++){//végig iterálunk a tömbön egy növekményes for ciklussal

    const jelenElem  = array[a]; //deklarálok egy block szintű változót, aminek értékül adom az array jelenlegi ciklusváltozó számú elemet
